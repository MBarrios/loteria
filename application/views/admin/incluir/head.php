...
<head>
    ...
    <meta name="author" content="OSSG" />

    <title>Loteria</title>
    <title>Sistema de Control </title>
    <link rel="icon" href="<?=__MAQ__?>images/favicon.ico" type="image/x-icon" />
    ...
    <link rel="stylesheet" href="<?= __MAQ__ ?>admin/js/wysihtml5/bootstrap-wysihtml5.css">
    <link rel="stylesheet" href="<?= __MAQ__ ?>jquery-ui.css">

    <script src="<?= __MAQ__ ?>jquery-1.12.4.js"></script>
    <script src="<?= __MAQ__ ?>jquery-ui/jquery-ui.js"></script>
